...
public class ViewCapturer implements VideoCapturer, VideoSink {
    ...
    public ViewCapturer(ViewHolder holder, int framePerSecond) {
        if (framePerSecond <= 0)
    ...
    public void stopCapture() throws InterruptedException {
        this.checkNotDisposed();
        ViewCapturer.this.surfaceTextureHelper.stopListening();
        ViewCapturer.this.capturerObserver.onCapturerStopped();
        started.set(false);
